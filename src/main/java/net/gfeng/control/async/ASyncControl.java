...
//www.cnblogs.com/baixianlong/p/10661591.html
...
public class ASyncControl {
	...
	//Method 4 DeferredResult可以处理一些相对复杂一些的业务逻辑，最主要还是可以在另一个线程里面进行业务处理及返回，即可在两个完全不相干的线程间的通信。
	private Executor myThreadPoolTaskExecutor = Executors.newCachedThreadPool();
